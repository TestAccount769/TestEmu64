...
deploy_turnip "https://raw.githubusercontent.com/turnip1.tar" "turnip_steven_ci" "libvulkan_freedreno.so"
deploy_turnip "https://raw.githubusercontent.com/turnip2.tar" "turnip_v26_2_0_r2" "libvulkan_freedreno.so"
deploy_turnip "https://raw.githubusercontent.com/turnip3.tar" "turnip_kimchi_r7" "vulkan.ad07xx.so"
deploy_turnip "https://raw.githubusercontent.com/turnip4.tar" "turnip_weab_chan" "libvulkan_freedreno.so"
deploy_turnip "https://raw.githubusercontent.com/turnip5.tar" "turnip_hooke-speed" "vulkan.ad07xx.so"
deploy_turnip "https://raw.githubusercontent.com/turnip6.tar" "turnip_stock" "libvulkan_freedreno.so"

deploy_dxvk "https://raw.githubusercontent.com/dxvk1.tar" "gplasync_2.7.1" "dxvk-2.7.1"
deploy_dxvk "https://raw.githubusercontent.com/dxvk2.tar" "gproton_2.7" "dxvk-2.7"
deploy_dxvk "https://raw.githubusercontent.com/dxvk3.tar" "native_2.7.1" "dxvk-2.6"
deploy_dxvk "https://raw.githubusercontent.com/dxvk4.tar" "async_2.0" "dxvk-2.3"
deploy_dxvk "https://raw.githubusercontent.com/dxvk5.tar" "d8vk_1.0" "d8vk"
...
curl -L -H "Authorization: token $GITHUB_TOKEN" -o /tmp/optimization-script.zip "$BASE_URL/optimization-script.zip"

mkdir -p \
"$PREFIX/glibc/opt/core" \
"$PREFIX/glibc/opt/conf" \
"$PREFIX/glibc/opt/drivers" \
"$PREFIX/glibc/opt/bat-files" \
"$PREFIX/glibc/opt/scripts"
...
/tmp/drivers.tar \
/tmp/booster.7z \
/tmp/optimization-script.zip \
"$TMP_DIR"

chmod +x "$PREFIX/glibc/opt/scripts/testemu64" 2>/dev/null
chmod +x "$PREFIX/glibc/opt/scripts/testemu-optimizer.sh" 2>/dev/null
